                              ...
                              <div class="col-lg-12">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <textarea id="{{ $language->code }}_description"  onfocusout="saveDraftData(this , 'ad_description')"  class="form-control "
                                    name="{{ $language->code }}_description" data-height="500" style="height: 300px;" placeholder = "Tell us a bit more about your ad, giving us as much information as possible to help sell your items">@if($draft_ad == true && !empty($draft_ad->ad_description)){{$draft_ad->ad_description}}@endif</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="full_name" value="{{ $vendor->vendor_info->name }}" disabled>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
