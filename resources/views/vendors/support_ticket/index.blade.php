                    ...
                    <tbody>
                        ...
                        <form method="get" id="submitForm" action="{{route('vendor.support_tickets.multi.delete')}}">
                            ...
                            <td class="" style=" padding-right: 0px !important;padding-left: 10px !important;" >
                              ...
                              <td class="us_td_img text-center" style="padding: 0; cursor: pointer;" onclick="window.location.href='{{ route('vendor.support_tickets.message', $item->id) }}'">
                                  @if ($carDetail->feature_image != null)
                                  <img class="mb-1 img-thumbnail us_img_cust" style="height: auto; width: 200px; max-width: 70px; border-radius: 50%;" src="{{ asset('assets/admin/img/car-gallery/'. $carDetail->feature_image) }}" alt="Car Image">
                                  @endif
                              </td>
