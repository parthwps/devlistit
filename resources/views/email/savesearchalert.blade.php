    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 1rem;" class="email-container">
      ...
      <tr style="border-bottom: 3px solid rgba(0,0,0,.05);">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" >
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h2><center>Saved Alerts</center></h2>
            				<h3 style="margin-bottom: 0px;">New Ads just listed related to your saved searches. Please check</h3>
            			</div>
            		</td>
            	</tr>
            </table>
	      ...
	      <td style="padding: 20px 24px">
            ...
            <tr colspan ="2">
            <td width="100%" style="text-align:left; padding: 0.5em 0.9em; color: #000; padding-bottom: 4px; font-size: 20px; font-weight: 600;">
               @foreach($userArray as $data)
            <div style="border-bottom: 1px solid #c8c8c8;border-radius: 5px;">
             
                <div style="">
                    <p style="margin-top: 0px;margin-bottom: 0px;">{{$data['save_search_name']}}   </p>
                    <div style="color: gray;font-size: 16px;font-weight: 300;">Total new ads in this <b> ({{$data['countertotal']}}) </b> </div>
                    
                    <a href="{{$data['search_url']}}" style="font-weight: 400;font-size: 17px;">Check now</a>
