                        ...
                        <div class="accordion-body scroll-y mt-20">
                            ...
                            @if($category_filters && in_array('model' , $category_filters))
                                <div class="widget widget-ratings p-0 mb-20">
                                    ...
                                    <div id="models" class="collapse show">
                                        <div class="accordion-body  mt-20">
                                            <ul class="list-group custom-checkbox" id="appendModels">
                                                <select class="form-select form-control js-example-basic-single1" onchange="updateUrl(); checkEnableAddButton()"
                                                        name="models[]">
                                    ...
                                    <br/>
                                    <button type="submit" class="btn btn-light d-flex align-items-center justify-content-center border rounded-2"
                              ...
                              <div class="col-12">
                                  <div class="form-group" style="padding:10px 0px;">
                                      <div class="col-12 mb-3">
                                          <button class="btn btn-primary" id="total_price_button" onclick="updateUrl()">{{ __('Total Price') }}</button>
                                          <button class="btn btn-primary" id="per_month_button" onclick="updateUrl()">{{ __('Per Month') }}</button>
                                      </div>
                                                  ...
                                                  <div class="col-6">
                                                      <select class="form-select form-control js-example-basic-single1"
                                                          ...
                                                          @foreach ($engine_sizes as $engine_size)
                                                              <option value="{{ $engine_size }}" @selected(request()->input('engine_min') == $engine_size)>{{ $engine_size }}</option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                                  <div class="col-6">
                                                      <select class="form-select form-control js-example-basic-single1"
                                                          ...
                                                          @foreach ($engine_sizes as $engine_size)
                                                              <option value="{{ $engine_size }}" @selected(request()->input('engine_max') == $engine_size)>{{ $engine_size }}</option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                              </div>
                                                  ...
                                                  <div class="col-6">
                                                      <select class="form-select form-control js-example-basic-single1"
                                                          ...
                                                          @foreach ($engine_power as $engine_power_value)
                                                              <option value="{{ $engine_power_value }}" @selected(request()->input('power_min') == $engine_power_value)>{{ $engine_power_value }}</option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                                  <div class="col-6">
                                                      <select class="form-select form-control js-example-basic-single1"
                                                          ...
                                                          <option value="">{{ __('To') }}</option>
                                                          @foreach ($engine_power as $engine_power_value)
                                                              <option value="{{ $engine_power_value }}" @selected(request()->input('power_max') == $engine_power_value)>{{ $engine_power_value }}</option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                              </div>
