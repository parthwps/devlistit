    ...
    <div class="container">
        <div class="content">
            <ul class="list-unstyled pb-2 topbreadcrumb">
                ...
                <li class="d-inline" style="margin-right:10px;"><a class="font-sm"
                        href="{{ URL::previous() }}">{{ __('Back') }}</a></li>
            ...
            <div class="col-lg-4 col-xl-3">
                <div class="widget-offcanvas offcanvas-lg offcanvas-start" tabindex="-1" id="widgetOffcanvas"
                    ...
                    <div class="offcanvas-header px-20">
                        <button type="button" class="btn-close us_btn_close" data-bs-dismiss="offcanvas"
                        ...
                        <form action="{{ route('frontend.cars') }}" method="get" id="searchForm" class="w-100">
                            ...
                            <aside class="widget-area" data-aos="fade-up">
                                <div class="widget widget-select p-0 mb-20">
                                    <div class="row">
                                        <div class="col-12 pb-40"><a href="javascript:void(0);" onclick="SaveSeraches()"
                                                class="btn btn-lg btn-outline active icon-start w-100"><i
                                                    class="fal fa-star fa-lg"
                                                    style="color: orange;"></i>{{ __('Save Search') }}</a></div>
                                        <div class="col-6">
                                            <h4>Filters</h4>
                                        </div>
                                        <div class="col-6 text-right">
                                            <div class="cta">
                                                <a href="{{ route('frontend.cars') }}"
                                                    class="btn btn-sm btn-primary icon-start us-filter-reset"><i
            ...
            <div class="col-lg-8 col-xl-9" id="ajaxcall">
                <div class="product-sort-area" data-aos="fade-up">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <h4 class="mb-20" id="total_counter_with_category">{{ $total_cars }}
                                {{ $total_cars > 1 ? __('Ads') : __('Ads') }}
                                {{ __('Found') }}
                                @if (!empty(request()->input('category')))
                        ...
                        <div class="col-8 col-lg-6">
                            <ul class="product-sort-list list-unstyled mb-20">
                                <li class="item me-4">
                                    <div class="sort-item d-flex align-items-center">
                                        ...
                                        <select name="sort" class="nice-select right color-dark" onchange="updateUrl()">
                                            ...
                                            @if(request()->category && (request()->category == 'cars' ||
                                            request()->category == 'cars-&-motors' ) )
                                            <option
                                                {{ request()->input('sort') == 'high-to-mileage' ? 'selected' : '' }}
                                                value="high-to-mileage">
                                                {{ __(' Highest  mileage') }}</option>
                                            <option {{ request()->input('sort') == 'low-to-mileage' ? 'selected' : '' }}
                                                value="low-to-mileage">
                                ...
                                <li class="item">
                                    ...
                                    @endphp
                                    <a href="{{ route('frontend.cars', $queryParamsList) }}"
                                        class="btn-icon @if(empty(request()->type) || request()->type == 'list') active @endif"
                                        data-tooltip="tooltip" data-type='list' data-bs-placement="top"
                                        title="{{ __('List View') }}">
                                ...
                                <li class="item">
                                    ...
                                    @endphp
                                    <a href="{{ route('frontend.cars', $queryParamsGrid) }}"
                                        class="btn-icon @if(!empty(request()->type) && request()->type == 'grid') active @endif"
                                        data-tooltip="tooltip" data-type="grid" data-bs-placement="top"
                                        title="{{ __('Grid View') }}">
                ...
                <div class="row" id="ajaxListing">
                    ...
                    <div class="col-12" data-aos="fade-up">
                        ...
                        <div class="row g-0 product-default product-column border mb-30 align-items-center p-15"
                            style="<?= ( $car_content->vendor->vendor_type == 'normal' ) ? 'border-top: 5px solid #ff9e02 !important;' : '' ?> padding: 0px !important;transform: translateY(-5px);box-shadow: 0px 0px 20px gray; border-radius:5px;"
                            data-id="{{$car_content->id}}">
                            @else
                            <div class="row g-0 product-default product-column border mb-30 align-items-center p-15"
                                style="padding: 0px !important;transform: translateY(-5px);box-shadow: 0px 0px 20px gray; border-radius:5px;"
                                data-id="{{$car_content->id}}">
                                @endif
                                ...
                                <div class="col-md-12" style="border-bottom: 5px solid #ff9e02;">
                                    ...
                                    <div class="col-md-12" style="border-bottom: 1px solid #e9e9e9;">
                                        ...
                                        <div class="author mb-15 us_parent_cls">
                                            ...
                                            <a style="padding-top: 1rem;display: flex;padding-left: 1rem;"
                                                class="color-medium"
                                                ...
                                                @php
                                                $photoUrl = env('SUBDOMAIN_APP_URL').'assets/admin/img/vendor-photo/' .
                                                $car_content->vendor->photo;

                                                if (file_exists(public_path('assets/admin/img/vendor-photo/' .
                                                $car_content->vendor->photo))) {

                                                $photoUrl = asset('assets/admin/img/vendor-photo/' .
                                                $car_content->vendor->photo);
                                                }
                                                @endphp

                                                <img style="border-radius: 10%; max-width: 60px;"
                                                    class="lazyload blur-up"
                                                    src="{{ asset('assets/img/blank-user.jpg') }}"
                                                    data-src="{{ $photoUrl }}" alt="Vendor"
                                                ...
                                                <span>
                                                    ...
                                                    <strong class="us_font_15"
                                                        style="color: black;font-size: 20px;">{{ $car_content->vendor->vendor_info->name }}
                                                    </strong>
                                                    ...
                                                    @php
                                                    $review_data =
                                                    get_vendor_review_from_google($car_content->vendor->google_review_id
                                                    , true);
                                                    @endphp
                                                    @endif
                                                    ...
                                                    <div style="display: flex;">Franchise Dealer
                                                        ...
                                                        $review_data['total_ratings'] > 0)
                                                        . <span>
                                                            <div class="rating-container"
                                                                style="font-size: 15px;margin-top: -0.4rem;">
                                                                <span class="star on"></span>
                                                                {{$review_data['total_ratings']}}/5
                                                            </div>
                                                        </span>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="us_trusted"> <span
                                                    style="background: #0fbd0f;color: white;padding: 1px 10px;border-radius: 20px;font-size: 12px;margin-left: 0.5rem;"><i
                                                        class="fa fa-check" aria-hidden="true"></i> Trusted Dealer
                                                </span></div>
                                            @endif

                                            @if($car_content->is_sold == 1)
                                            <div class="us_trusted"> <span
                                                    style="background: #ff2f00; margin-left:5px;color: white;padding: 1px 10px;border-radius: 20px;font-size: 12px;"><i
                                                        class="fa fa-check" aria-hidden="true"></i> Sold </span></div>
                                            @endif
                                    ...
                                    <figure class="product-img col-xl-4 col-lg-5 col-md-6 col-sm-12">
                                        ...
                                        @if($car_content->is_featured == 1)
                                        <div class="sale-tag"
                                            style="border-bottom-right-radius: 0px;     background: #ff9e02;">Spotlight
                                        </div>
                                        @endif
                                        ...
                                        <a href="{{ route('frontend.car.details', ['cattitle' => catslug($car_content->category_id),'slug' => $car_content->slug, 'id' => $car_content->id]) }}"
                                            ...
                                            <img class="lazyload"
                                                ...
                                                alt="Product" style="transform: rotate({{$rotation}}deg);"
                                                onerror="this.onerror=null;this.src='{{ asset('assets/img/noimage.jpg') }}';">
                                    ...
                                    <div class="product-details col-xl-8 col-lg-7 col-md-6 col-sm-12 border-lg-end pe-lg-2"
                                        style="margin-top:0.5rem;cursor:pointer;padding-left: 15px;"
                                        onclick="window.location='{{ route('frontend.car.details', ['cattitle' => catslug($car_content->category_id), 'slug' => $car_content->slug, 'id' => $car_content->id]) }}'">

                                        <span class="product-category font-sm " style=" display: flex;">

                                            <h5 class="product-title "><a
                                                    href="{{ route('frontend.car.details', ['cattitle' => catslug($car_content->category_id),'slug' => $car_content->slug, 'id' => $car_content->id]) }}">{{ carBrand($car_content->brand_id) }}
                                        ...
                                        <div class="author mb-10 us_child_dv">
                                            ...
                                            <span>
                                                ...
                                                <b class="us_dot"> - </b> {{ number_format( $car_content->mileage ) }}
                                                mi
                                                @endif
                                        ...
                                        <div style="display:flex;margin-top: 1rem;margin-bottom: 1.5rem;">
                                            ...
                                            <div class="price-tag"
                                                style="padding: 3px 5px;border-radius:5px; background:#25d366;font-size: 10.5px;">
                                                Manage Special</div>
                                            @endif

                                            @if($car_content->is_sale == 1)
                                            <div class="price-tag"
                                                style="padding: 3px 5px;border-radius:5px;margin-left: 10px;background:#434d89;font-size: 10.5px;">
                                                Sale </span></div>
                                            @endif

                                            @if($car_content->reduce_price == 1)
                                            <div class="price-tag"
                                                style="padding: 3px 5px;border-radius:5px;margin-left: 10px;background:#ff4444;font-size: 10.5px;">
                                                Reduced </span></div>
                                            @endif

                                            @if(!empty($car_content->warranty_duration))
                                            <div class="price-tag"
                                                style="padding: 3px 5px;border-radius: 5px;margin-left: 10px;background: #ebebeb;font-size: 10.5px;color: #525252;border: 1px solid #d6d6d6;box-shadow: 0px 0px 5px gray;">
                                                {{$car_content->warranty_duration}} Warranty</span></div>
                                            @endif
                                        ...
                                        <ul class="product-icon-list  list-unstyled d-flex align-items-center"
                                            ...
                                            <li class="icon-start" data-tooltip="tooltip" data-bs-placement="top"
                                                ...
                                                <br>
                                                <strong class="us_mrg"
                                                    style="color: black;font-size: 20px;    margin-left: 0;">
                                                    @if($car_content->previous_price && $car_content->previous_price <
                                                        $car_content->price)
                                                        <strike
                                                            style="font-weight: 300;color: red;font-size: 14px;    float: left;">{{ symbolPrice($car_content->price) }}</strike>
                                            ...
                                            <li class="icon-start" data-tooltip="tooltip" data-bs-placement="top"
                                                ...
                                                <strong style="color: black;font-size: 20px;">{!!
                                                    calulcateloanamount(!empty($car_content->previous_price &&
                                                    $car_content->previous_price < $car_content->price ) ?
                                                        $car_content->previous_price : $car_content->price)[0]
                                                        !!}</strong>
                                            </li>
                                            @endif
                                    ...
                                    <a href="javascript:void(0);" onclick="addToWishlist({{$car_content->id}})"
                                    ...
                                    <a href="javascript:void(0);"
                                        class="us_wishlist2 btn-icon us_list_downside us_share_icon "
                                        style=" color: #1b87f4 !important;" onclick="openShareModal(this)"
                    ...
                    "><i class="fa fa-share-alt" aria-hidden="true"></i>
                            ...
                            <div class="pagination us_pagination_default  mb-40 justify-content-center"
                                data-aos="fade-up">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-3" data-aos="fade-up">
                ...
                <div class="product-default border p-15 mb-25 set_height"
                    style="padding: 0px !important;box-shadow: 0px 0px 10px #868686;border-radius: 10px;"
                    data-id="{{$featureads->id}}">
                    ...
                    <div class="product-details" style="padding: 7px !important;padding-left: 15px !important;">
                        ...
                        <span class="product-category font-xsm">
                            ...
                            <h5 class="product-title mb-0"
                                style="display: inline-block;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 250px;vertical-align: top;">
                                <a href="{{ route('frontend.car.details', ['cattitle' => catslug($featureads->car_content->category_id),'slug' => $featureads->car_content->slug, 'id' => $featureads->id]) }}"
                                    title="{{ optional($featureads)->title }}">{{ carBrand($featureads->car_content->brand_id) }}
                                    {{ carModel($featureads->car_content->car_model_id) }}
                                    {{ optional($featureads->car_content)->title }}</a>
                            </h5>
                        ...
                        <div class="d-flex align-items-center justify-content-between ">
                            ...
                            <a href="javascript:void(0);" onclick="addToWishlist({{$featureads->id}})"
                                class="btn us_wishlist btn-icon " data-tooltip="tooltip" data-bs-placement="right"
                        ...
                        <div class="author us_child_dv" style="cursor:pointer;margin-top: 0px;"
                        ...
                        <ul class="product-icon-list  list-unstyled d-flex align-items-center"
                            ...
                            <li class="icon-start" data-tooltip="tooltip" data-bs-placement="top" title="Price">
                                <b style="color: gray;">Price</b>
                                <br>
                                <strong class="us_mrg" style="color: black;font-size: 20px;">
                                    @if($featureads->previous_price && $featureads->previous_price < $featureads->price
                                        ...
                                        <strike
                                            style="font-weight: 300;color: red;font-size: 14px;    float: left;">{{ symbolPrice($featureads->price) }}</strike>
                                        <div> {{ symbolPrice($featureads->previous_price) }}</div>
                                        @else
                                        <strike style="font-weight: 300;color: white;font-size: 14px;    float: left;">
                                        </strike>
                                        <div> {{ symbolPrice($featureads->price) }} </div>
                            ...
                            <li class="icon-start" data-tooltip="tooltip" data-bs-placement="top" title="">
                                ...
                                <strong style="color: black;font-size: 20px;display:flex;">
                                    ...
                                    {!! calulcateloanamount(!empty($featureads->previous_price &&
                                    $featureads->previous_price < $featureads->price ) ? $featureads->previous_price :
                                        $featureads->price)[0] !!}
            ...
            <div class="col-12 col-md-3" data-aos="fade-up">
                ...
                <div>
                    <h4 style="color:white;font-size: 30px;">{{$getFeaturedVendors->vendor_info->name}}</h4> <br>
                    <span style="color:white;display: flex;    margin-bottom: 1rem;">
                        <div>
                            {{($getFeaturedVendors->is_franchise_dealer == 1) ? 'Franchise' : 'Independent' }} Dealer
                        </div> <b style="margin: 0px 10px;"> - </b>
                        <div>Total stock: {{$getFeaturedVendors->cars_count}} Ads</div> <br>

                    </span>

                    <a href="{{ route('frontend.vendor.details', ['id' => $getFeaturedVendors->id ,  'username' => ( $getFeaturedVendors->username)]) }}"
                        style="color: white;text-decoration: underline;">See Showroom</a>
                ...
                margin-top: 1rem;">FEATURED</div>
                    ...
                    <img style="border-radius: 10%; max-width: 60px;" class="lazyload blur-up"
                        src="{{ asset('assets/img/blank-user.jpg') }}" data-src="{{ $photoUrl }}" alt="Vendor"
                        onload="handleImageLoad(this)" onerror="{{ asset('assets/img/blank-user.jpg') }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{getSetVal('finance_url')}}" class="btn btn-info" style="width: 100%;color: white;">Get
                    Finance Aproval</a>
            </div>
