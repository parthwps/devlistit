                  ...
                  <span class="small text-secondary">
                   - 	{{calculate_datetime($car->created_at)}}
                      ...
                      <li class="icon-start" data-tooltip="tooltip" data-bs-placement="top"
                       ...
                       @if($car->previous_price && $car->previous_price < $car->price)
                         ...
                         {{ symbolPrice($car->price) }}</strike> <br>
                          <div style="color:black;" > {{ symbolPrice($car->previous_price) }}</div>
                          @else
                      ...
                      @endif
                       ...
                       @if ($car->price != null && $car->price >= 1000)
                          <li class="icon-start" style="border-bottom: 2px solid #00000;" data-tooltip="tooltip" data-bs-placement="top"
                            ...
                            <strong style="color: black;font-size: 20px;"  data-price="{{ calulcateloanamount(!empty($car->previous_price && $car->previous_price < $car->price) ?
                    ...
                    @if ($car->price != null && $car->price >= 1000)
					  ...
					  <div class="col-md-4 " style="position: absolute;bottom: 10px;right: 0px;">
						...
						<div class="d-flex justify-content-end">
						     ...
						     <div class="social-link us_socail_links style-2 mb-20">
                    ...
                    <a data-tooltip="tooltip" data-bs-placement="top"
                      ...
                      ><i class="fas fa-link"></i></a>
                        ...
                        <a href="javascript:void(0);" class="us_icon_show  btn-icon  us_share_icon" style=" color: #1b87f4 !important;
                            right: 0px !important;    font-size: 20px;" onclick="openShareModal(this)" 
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 ">
                                <div class="col-md-12 m-2 clearfix p-3">
                         ...
                         <div class="col-lg-6 ">
                            <div class="col-md-11 mt-15 clearfix">
                                <div class="">
                                    @if (Auth::guard('vendor')->check() ) 
					...
					<div class="card-body">
						<div class="product-desc">
						  <h4 class="mb-20">{{ __('Description') }}  </h4>
                                ...
                                <div id="car-description" class="partial-description">{!! optional($car->car_content)->description !!}</div>
                                <button id="read-more" style="margin-left: -3px;display:none;color: #00278c;">Read More</button>
                                <button id="read-less" style="display:none;margin-left: -3px;color: #00278c;">Read Less</button>
                                </div>
						</div>
					</div>
				</div>
...
<script src="{{ asset('assets/js/bootstrap.min.js') }}"></script>
  ...
  setTimeout(()=>{
    ...
    {
        var contentHeight = $('#car-description').height();
        
        if (contentHeight > 169) 
        {
