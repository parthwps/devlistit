...
@endphp
  ...
  <div class="row gx-xl-5">
   ...
   <div class="col-md-12">
    ...
    <form id="my-checkout-form" action="{{ route('web.plan.checkoutsuccess') }}" method="post"
          ...
          <input type="hidden" name="request_mode" value="apis">
          ...
          style: {
            ...
            createOrder: function(data, actions) {
                ...
                payer: {
                  ...
                  email_address: '<?php echo $vendor->email; ?>',
                  phone: {
                    phone_number: {
                  ...
                  name: {
                    given_name: '<?php echo $vendor->vendor_info->name; ?>',
            ...
            {
                var ad_id = "{{$ad_id->id}}"
                var appUrl = "{{ session('appUrl')}}"
                window.location.href="/paypal-response/error/"+ad_id+'?msg=Transaction canceled&appUrl='+appUrl;
                    // Handle cancelation
                ...
                onError: function(err) {
                    ...
                    window.location.href="/paypal-response/error/"+ad_id+'?msg=Error occurred, please try again.&appUrl='+appUrl;
