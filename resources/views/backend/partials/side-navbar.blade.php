    ...
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Package Management', $rolePermissions)))
          <li
            ...
            <div id="packageManagement"
             ...
             <!--    <li class="{{ request()->routeIs('admin.private_package.settings') ? 'active' : '' }}">
                  <a href="{{ route('admin.private_package.settings', ['language' => $defaultLang->code]) }}">
                    <span class="sub-item">Settings</span>
                  </a>
                </li> -->

                <li class="{{ request()->routeIs('admin.private_package.index') ? 'active' : '' }}">
                  <a href="{{ route('admin.private_package.index', ['language' => $defaultLang->code]) }}">
                    <span class="sub-item">Packages</span>
                  </a>
                </li>
              </ul>
        ...
        @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Payment Log', $rolePermissions)))
          <li class="nav-item @if (request()->routeIs('admin.edit_management.invoice')) active @endif">
            <a href="{{ route('admin.edit_management.invoice') }}">
          ...
          <li
            ...
            <div id="carManagement"
              ...
              <ul class="nav nav-collapse">
                ...
                <li class="{{ (request()->routeIs('admin.car_management.car') && empty(request()->status)) || (request()->routeIs('admin.cars_management.edit_car') && empty(request()->status)) ? 'active' : '' }}">
    <a href="{{ route('admin.car_management.car', ['language' => $defaultLang->code]) }}">
        <span class="sub-item">Manage Ads</span>
    </a>
</li>

<li class="{{ (request()->routeIs('admin.car_management.car') && request()->status == 'sold') || (request()->routeIs('admin.cars_management.edit_car') && request()->status == 'sold') ? 'active' : '' }}">
    <a href="{{ route('admin.car_management.car', ['language' => $defaultLang->code, 'status' => 'sold']) }}">
        <span class="sub-item">Sold Ads</span>
    </a>
</li>

<li class="{{ (request()->routeIs('admin.car_management.car') && request()->status == 'removed') || (request()->routeIs('admin.cars_management.edit_car') && request()->status == 'removed') ? 'active' : '' }}">
    <a href="{{ route('admin.car_management.car', ['language' => $defaultLang->code, 'status' => 'removed']) }}">
...
active @endif
        ...
        @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Vendors Management', $rolePermissions)))
          <li
            ...
            <div id="vendors"
              class="collapse
              @if (request()->routeIs('admin.dealer_management.registered_dealer')) show
              @elseif (request()->routeIs('admin.vendor_management.vendor_details')) show
              @elseif (request()->routeIs('admin.edit_management.vendor_edit')) show
              @elseif (request()->routeIs('admin.dealer_management.add_dealer')) show
              ...
              <ul class="nav nav-collapse">
                ...
                <li
                  ...
                  @elseif (request()->routeIs('admin.edit_management.vendor_edit')) active
                  @elseif (request()->routeIs('admin.vendor_management.vendor.change_password')) active @endif">
                  <a href="{{ route('admin.dealer_management.registered_dealer') }}">
                    <span class="sub-item">Registered Dealers</span>
                  </a>
                </li>
                <li class="@if (request()->routeIs('admin.dealer_management.add_dealer')) active @endif">
                  <a href="{{ route('admin.dealer_management.add_dealer') }}">
