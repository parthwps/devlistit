  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Car Body Type') }}</h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.car_specification.store_body_type') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <p class="text-warning mt-2 mb-0">
              <small>{{ __('The higher the serial number is, the later the Brand type will be shown.') }}</small>
            </p>
          </div>
          <div class="form-group">
