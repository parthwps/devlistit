  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Car Brand Type') }}</h5>
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.car_specification.update_body_type') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <select name="cat_id" id="in_cat_id" class="form-control">
