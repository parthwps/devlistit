                 ...
                 <div class="row mt-3">
                  <div class="col-lg-12">
                    <div class="form-group p-0">
                      ...
                      <select name="page_type" class="form-control" onchange="showOption(this)">
                        <option value="default" {{ $page->page_type == 'default' ? 'selected' : '' }} >{{ __('Default') }}</option>
                        <option value="file" {{ $page->page_type == 'file' ? 'selected' : '' }} >{{ __('File') }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body">
                          <div class="row">
                           ...
                           <div class="row us_hidden_file <?= ($page->page_type == 'default') ? 'd-none' : '' ?> "  >
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                <label>File</label>
                          ...
                          <div class="row us_default_hidden <?= ($page->page_type == 'file') ? 'd-none' : '' ?>">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
...
@section('script')
  <script type="text/javascript" src="{{ asset('assets/js/admin-partial.js') }}"></script>
   ...
   <script>
      function showOption(self)
      {
          var ThisVal = $(self).val();
          
          if(ThisVal == 'default')
          {
              $('.us_default_hidden').show();
              $('.us_default_hidden').removeClass('d-none');
              $('.us_hidden_file').hide();
          }
          else
          {
               $('.us_default_hidden').hide();
               $('.us_hidden_file').removeClass('d-none');
              $('.us_hidden_file').show();
          }
      }
  </script>
