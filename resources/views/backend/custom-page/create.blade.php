        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="pageForm" action="{{ route('admin.custom_pages.store_page') }}" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="version">
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body">
                          ...
                          <div class="row us_hidden_file" style="display:none;" >
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                <label>File</label>
                          ...
                          <div class="row us_default_hidden">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
