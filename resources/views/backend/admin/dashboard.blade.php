...
<!-- 
    ...
    @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('User Management', $rolePermissions)))
      <div class="col-sm-6 col-md-4">
        <a href="{{ route('admin.car_management.car') }}">
    ...
    @if (is_null($roleInfo) && Auth::guard('admin')->check() )
    
      <div class="col-md-4">
        <a href="{{ route('admin.car_management.car' , ['language' => 'en' , 'status' => 'sold']) }}">
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <div class="card-title">Monthly Registered Users ({{ date('Y') }})</div>
        </div>
...
@section('script')
 ...
 <script>
  ...
  <script type="text/javascript" src="{{ asset('assets/js/chart-init.js?v=0.2') }}"></script>
@endsection
