    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="{{ route('admin.advertise.store_advertisement') }}"
          ...
          <div class="form-group d-none" id="expire_date_input">
            <label for="">{{ __('Expire Date') . '*' }}</label>
            <input type="date" class="form-control" name="expire_at" value="{{date('Y-m-d')}}" min="{{date('Y-m-d')}}" placeholder="Enter Redirect URL">
