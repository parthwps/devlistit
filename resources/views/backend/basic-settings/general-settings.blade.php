        ...
        <form action="{{ route('admin.basic_settings.general_settings.update') }}" method="post"
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-10 mx-auto">
                ...
                <div class="row">
                  <div class="col-md-12">
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      <label>{{ __('Finance Url') . '*' }}</label>
                      <input type="text" class="form-control" name="finance_url"
                        value="{{ $data->finance_url != null ? $data->finance_url : '' }}"
                        placeholder="Enter finance url">
                      @if ($errors->has('finance_url'))
                        <p class="mt-2 mb-0 text-danger">{{ $errors->first('finance_url') }}</p>
                      @endif
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                      <label for="">{{ __('Dealer Portal Logo') . '*' }}</label>
                      <br>
                      <div class="thumb-preview">
                        @if (!empty($data->dealer_logo))
                          <img src="{{ asset('assets/img/' . $data->dealer_logo) }}" alt="dealer_logo" class="uploaded-img">
                        @else
                          <img src="{{ asset('assets/img/noimage.jpg') }}" alt="..." class="uploaded-img">
                        @endif
                      </div>
                      ...
                      <div class="mt-3">
                        <div role="button" class="btn btn-primary btn-sm upload-btn">
                            ...
                            width: 112px;
                            opacity: 0;" name="dealer_logo">
                        </div>
                      </div>
                      @if ($errors->has('dealer_logo'))
                        <p class="mt-2 mb-0 text-danger">{{ $errors->first('dealer_logo') }}</p>
                      @endif
              ...
              <input name="theme_version" type="radio" value="2" class="imagecheck-input" checked="">
              ...
              <div class="col-lg-10 mx-auto">
               ...
               <div class="col-lg-10 mx-auto">
                <h2 class="mt-3 text-warning">Spotlight Setup</h2>
                <hr>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>Price Per Spotlight</label>
                      <input type="text" class="form-control" name="per_spotlight_price"
                        value="{{ $data->per_spotlight_price != null ? $data->per_spotlight_price : '' }}"
                        placeholder="Enter Price for single spotlight">
                      @if ($errors->has('per_spotlight_price'))
                        <p class="mb-0 text-danger">{{ $errors->first('per_spotlight_price') }}</p>
                      @endif
                    </div>
                  </div>
                   ...
                   <div class="col-lg-6">
                    <div class="form-group">
                      <label>Day After Spotlight</label>
                      <input type="number" class="form-control" name="day_after_spotlight"
                        value="{{ $data->day_after_spotlight != null ? $data->day_after_spotlight : '' }}"
                        placeholder="Enter how many days after dealer can spotlight ads">
                      @if ($errors->has('day_after_spotlight'))
                        <p class="mb-0 text-danger">{{ $errors->first('day_after_spotlight') }}</p>
                      @endif
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>Price Per Bump</label>
                      <input type="text" class="form-control" name="per_bump_price"
                        value="{{ $data->per_bump_price != null ? $data->per_bump_price : '' }}"
                        placeholder="Enter Price for single Bump">
                      @if ($errors->has('per_bump_price'))
                        <p class="mb-0 text-danger">{{ $errors->first('per_bump_price') }}</p>
                      @endif
                    </div>
                  </div>
                   ...
                   <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="per_ad_price"
                        value="{{ $data->per_ad_price != null ? $data->per_ad_price : '' }}"
                        placeholder="Enter Price for single Ad">
                      @if ($errors->has('per_ad_price'))
                        <p class="mb-0 text-danger">{{ $errors->first('per_ad_price') }}</p>
                      @endif
                    </div>
                  </div>
                </div>
