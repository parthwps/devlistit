...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Edit Dealer') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.vendor_management.registered_vendor') }}">{{ __('Registered Dealer') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{ __('Edit Dealer') }}</a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-12">
              <div class="card-title">{{ __('Edit Dealer') }}</div>
            </div>
          </div>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <br>
                       <div class="thumb-preview">
                        ...
                        <img src="{{$photoUrl}}" alt="..." class="uploaded-img">
                        @else
                          ...
                          <div id="collapse{{ $language->id }}"
                            ...
                            <div class="version-body">
                              <div class="row">
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group">
                                    ...
                                    <input type="text"
                                      value="Isle of Man"
                                      class="form-control" readonly name="{{ $language->code }}_country"
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" value="{{ !empty($vendor) ? $vendor->est_year : '' }}" id="selected_value">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" value="{{ !empty($vendor) ? $vendor->website_link : '' }}" class="form-control"
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group">
                                    ...
                                    <input type="text"
                                      value="{{ $vendor->google_review_id }}"
                                      class="form-control" name="google_review_id"
                                      placeholder="{{ __('Enter Customer ID For Google Review') }}">
                                    </p>
                                  </div>
                                </div>
