...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Dealer Details') }}</h4>
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-header">
              <div class="h4 card-title">{{ __('Dealer Information') }}</div>
              <h2 class="text-center">
                @if ($vendor->photo != null)
                        ...
                        <img src="{{$photoUrl}}" alt="..." class="uploaded-img" style="    max-width: 100px;
                        border-radius: 10px;
                        margin: 15px;">
                        @else
            ...
            <div class="card-body">
              <div class="payment-information">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div style="margin-top: 10px;margin-bottom: 10px;    display: flex;">
                      ...
                      <form action="{{ route('vendor.currPackage.remove') }}" style="width: 100%;" class="d-inline-block deleteForm"
                        method="POST">
                        @csrf
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-lg-8">
                    {{ ucfirst( @$vendor->vendor_info->city) }}
                  </div>
                </div>
