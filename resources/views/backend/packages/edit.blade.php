            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" class="" action="{{ route('admin.package.update') }}" method="post"
                ...
                <div class="form-group">
                  ...
                  <input id="title" type="text" class="form-control" readonly name="title" value="{{ $package->title }}"
                ...
                <div class="form-group">
                  <label class="form-label">{{ __('How many Bumps can the vendor use') }} *</label>
                  <input type="text" class="form-control" name="number_of_bumps"
                    placeholder="{{ __('How many Bumps can the vendor use') }}"
                    value="{{ $package->number_of_bumps }}">
                  <p id="err_number_of_car_add" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label class="form-label">{{ __('Enter how many times vendor can check history') }} *</label>
                  <input type="text" name="number_of_historycheck" class="form-control"
                    placeholder="{{ __('Enter how many times vendor can check history') }}"
                    value="{{ $package->number_of_historycheck }}">
                  <p id="err_number_of_car_featured" class="mb-0 text-danger em"></p>
                </div>
