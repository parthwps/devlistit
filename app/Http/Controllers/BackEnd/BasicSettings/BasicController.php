...
class BasicController extends Controller
{
  ...
  public function update_general_setting(Request $request)
  {
    ...
    $rules = [
      ...
      'finance_url' => 'required',
      'theme_version' => 'required|numeric',
      'preloader_status' => 'required',
      'base_currency_symbol' => 'required',
      'day_after_spotlight' => 'required',
      'per_spotlight_price' => 'required',
    ...
    if ($request->hasFile('dealer_logo')) {
      $dealer_logoName = UploadFile::update(public_path('assets/img/'), $request->file('dealer_logo'), $data->dealer_logo);
      
    } else {
      $dealer_logoName = $data->dealer_logo;
    }
    ...
    DB::table('basic_settings')->updateOrInsert(
      ...
      [
        ...
        'finance_url' => $request->finance_url,
        'logo' => $logoName,
        'dealer_logo' => $dealer_logoName,
        'favicon' => $iconName,
        'preloader' => $preloaderName,
        'preloader_status' => $request->preloader_status,
        'theme_version' => $request->theme_version,
        'day_after_spotlight' => $request->day_after_spotlight,
        'per_spotlight_price' => $request->per_spotlight_price,
        'per_bump_price' => $request->per_bump_price,
        'per_ad_price' => $request->per_ad_price,
        'primary_color' => $request->primary_color,
        'base_currency_symbol' => $request->base_currency_symbol,
        'base_currency_symbol_position' => $request->base_currency_symbol_position,
        'base_currency_text' => $request->base_currency_text,
