...
class AppServiceProvider extends ServiceProvider
{
  ...
  public function boot()
  {
    ...
    if (!app()->runningInConsole()) 
    {
      ...
      # code...
      $data = DB::table('basic_settings')->select('favicon', 'website_title','dealer_logo', 'logo', 'base_currency_text', 'base_currency_text_position')->first();
      ...
      View::composer('backend.*', function ($view) {
        ...
        $notification_count = AdReport::with(['car' => function($query) {
        ...
        $view->with('new_report', $notification_count);
