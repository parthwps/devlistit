...
Route::prefix('/admin')->middleware('auth:admin')->group(function () {
  ...
  Route::get('/change_trust_status', 'BackEnd\AdminController@change_trust_status')->name('admin.change_trust_status');
  Route::get('/change_dealer_type', 'BackEnd\AdminController@change_dealer_type')->name('admin.change_dealer_type');
  ...
  // upload file for update new cars
  
  Route::get('/upload-csv', 'BackEnd\PaymentLogController@uploadCsv')->name('admin.payment-log.uploadcsv');
  
  Route::post('/upload-csv', 'BackEnd\PaymentLogController@uploadCsvs')->name('admin.payment-log.upload.csv');
  ...
  // report add
  Route::get('/reported-ads', 'BackEnd\PaymentLogController@reportedAds')->name('admin.reported.ads');
  ...
  // ------- Private Packages ------
  Route::prefix('private-package')->group(function () {
    // Package Settings routes
    Route::get('/settings', 'BackEnd\PrivatePackageController@settings')->name('admin.private_package.settings');
    Route::post('/settings', 'BackEnd\PrivatePackageController@updateSettings')->name('admin.private_package.settings');
    // Package routes
    Route::get('packages', 'BackEnd\PrivatePackageController@index')->name('admin.private_package.index');
    Route::get('spotlight', 'BackEnd\PrivatePackageController@SpotLight');

    Route::post('package/upload', 'BackEnd\PrivatePackageController@upload')->name('admin.private_packagev.upload');
    Route::post('package/store', 'BackEnd\PrivatePackageController@store')->name('admin.private_package.store');
    Route::get('package/{id}/edit', 'BackEnd\PrivatePackageController@edit')->name('admin.private_package.edit');
    Route::post('package/update', 'BackEnd\PrivatePackageController@update')->name('admin.private_package.update');
    Route::post('package/{id}/uploadUpdate', 'BackEnd\PrivatePackageController@uploadUpdate')->name('admin.private_package.uploadUpdate');
    Route::post('package/delete', 'BackEnd\PrivatePackageController@delete')->name('admin.private_package.delete');
    Route::post('package/bulk-delete', 'BackEnd\PrivatePackageController@bulkDelete')->name('admin.private_package.bulk.delete');
  });
  ...
  Route::prefix('car-specification')->group(function () 
  {
    ...
    Route::get('/getfilters/{id}', 'BackEnd\Car\CategoryController@getFilters');
    ...
    // car body_type route
    Route::get('/body_type', 'BackEnd\Car\FuelTypeController@index_body_type')->name('admin.car_specification.body_type');
    Route::post('/store-body_type', 'BackEnd\Car\FuelTypeController@store_body_type')->name('admin.car_specification.store_body_type');
    Route::post('/update-body_type', 'BackEnd\Car\FuelTypeController@update_body_type')->name('admin.car_specification.update_body_type');
    Route::post('/delete-body_type/{id}', 'BackEnd\Car\FuelTypeController@destroy_body_type')->name('admin.car_specification.delete_body_type');
    Route::post('/bulk-delete-body_type', 'BackEnd\Car\FuelTypeController@bulkDestroy_body_type')->name('admin.car_specification.bulk_delete_body_type');
  ...
  Route::prefix('/vendor-management')->middleware('permission:User Management')->group(function () 
  {
    ...
    Route::get('/add-dealer', 'BackEnd\DealerManagementController@add')->name('admin.dealer_management.add_dealer');
    
    Route::get('/registered-dealers', 'BackEnd\DealerManagementController@index')->name('admin.dealer_management.registered_dealer');

    Route::get('/dealers-edit', 'BackEnd\DealerManagementController@edit')->name('admin.edit_management.dealer_edit');
    
    Route::get('/invoice-history', 'BackEnd\DealerManagementController@deposit')->name('admin.edit_management.deposit');
    
    Route::get('/invoices', 'BackEnd\DealerManagementController@invoice')->name('admin.edit_management.invoice');
    
    Route::get('/invoice/delete/{id}', 'BackEnd\DealerManagementController@invoiceDelete');
    
    Route::get('/invoice/status/change/{id}/{status}', 'BackEnd\DealerManagementController@invoiceChangeStatus');
    
    Route::post('/save-deposit', 'BackEnd\DealerManagementController@saveDeposit')->name('admin.vendor_management.save-deposit');
    
    Route::post('/deduct-deposit', 'BackEnd\DealerManagementController@saveDeduct')->name('admin.vendor_management.deduct-deposit');

    Route::get('/get-vendor-package-detail', 'BackEnd\VendorManagementController@getVendorPackageDetail')->name('admin.vendor_management.vendor_pakgdetails');
    
    Route::get('/add-vendor-package-detail', 'BackEnd\VendorManagementController@addVendorPackageDetail')->name('admin.vendor_management.vendor_addpakgdetails');
    ...
    Route::get('/secret-login/{id}', 'BackEnd\VendorManagementController@secret_login')->name('admin.vendor_management.vendor.secret_login');
     Route::get('/dealer-secret-login/{id}', 'BackEnd\DealerManagementController@dealer_secret_login')->name('admin.vendor_management.vendor.dealer_secret_login');
  });
  // vendor management route start
