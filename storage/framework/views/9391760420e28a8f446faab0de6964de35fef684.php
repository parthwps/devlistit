...
<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Registered Dealers')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#"><?php echo e(__('Dealers Management')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e(__('Registered Dealers')); ?></a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title"><?php echo e(__('All Dealers')); ?></div>
            </div>
            ...
            <div class="col-lg-8">
              ...
              <form class="float-right" style="display: flex;width: 100%;" action="<?php echo e(route('admin.dealer_management.registered_dealer')); ?>" method="GET">
          ...
          <div class="row">
            <div class="col-lg-12">
              <?php if(count($vendors) == 0): ?>
                <h3 class="text-center"><?php echo e(__('NO Dealers FOUND') . '!'); ?></h3>
              <?php else: ?>
                  ...
                  <table class="table table-striped mt-3">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="padding-left: 10px !important;min-width: 151px;"><?php echo e(__('Account Status')); ?></th>
                        <th scope="col" style="padding-left: 10px !important;min-width: 151px;"><?php echo e(__('Email Status')); ?></th>
                        <th scope="col" style="padding-left: 10px !important;min-width: 151px;"><?php echo e(__('Actions')); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td style="padding-left: 10px !important;  padding: 0 10px !important;"><?php echo e($vendor->username); ?></td>
                          <td style="padding-left: 10px !important;  padding: 0 10px !important;"><?php echo e($vendor->email); ?></td>
                          <td style="padding-left: 10px !important;  padding: 0 10px !important;"><?php echo e(empty($vendor->phone) ? '-' : $vendor->phone); ?></td>
                          <td style="padding-left: 10px !important;width: 150px;"><?php echo e(date('d F,Y' , strtotime($vendor->created_at))); ?></td>
                          
                           <td style="padding-left: 10px !important;   padding: 0 10px !important;">
                             
                            <div class="dropdown">
                                
                              <button class="btn btn-secondary dropdown-toggle btn-sm" style=" <?php if($vendor->is_trusted == 1): ?> background: #31ce36 !important;border: #31ce36 !important;  <?php else: ?> background: #a3a3a3 !important;border: #a3a3a3 !important;  <?php endif; ?>" type="button"
                                id="trusteddropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php if($vendor->is_trusted == 1): ?> Trusted <?php else: ?> Untrusted <?php endif; ?>
                              </button>

                              <div class="dropdown-menu" aria-labelledby="trusteddropdownMenuButton">
                                  
                                <a href="<?php echo e(route('admin.change_trust_status' , ['id' => $vendor->id , 'status' => 1 ])); ?>"
                                  class="dropdown-item">
                                  Yes
                                </a>
                                
                                <a href="<?php echo e(route('admin.change_trust_status' , ['id' => $vendor->id , 'status' => 0 ])); ?>"
                                  class="dropdown-item">
                                  No
                                </a>
                            ...
                            <div class="dropdown">
                              <button class="btn btn-secondary dropdown-toggle btn-sm" style=" <?php if($vendor->is_franchise_dealer == 1): ?> background: #31ce36 !important;border: #31ce36 !important;  <?php else: ?> background: #a3a3a3 !important;border: #a3a3a3 !important;  <?php endif; ?>" type="button"
                                id="trusteddropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php if($vendor->is_franchise_dealer == 1): ?> Franchise <?php else: ?> Independent <?php endif; ?>
                              </button>

                              <div class="dropdown-menu" aria-labelledby="trusteddropdownMenuButton">
                                <a href="<?php echo e(route('admin.change_dealer_type' , ['id' => $vendor->id , 'status' => 1 ])); ?>"
                                  class="dropdown-item">
                                  Franchise
                                </a>
                                
                                <a href="<?php echo e(route('admin.change_dealer_type' , ['id' => $vendor->id , 'status' => 0 ])); ?>"
                                  class="dropdown-item">
                                  Independent
                                </a>
                          ...
                          <td style="      padding-left: 10px !important;  padding: 0 10px !important;">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="<?php echo e(route('admin.vendor_management.vendor_details', ['id' => $vendor->id, 'language' => $defaultLang->code , 'type' => 'dealer' ])); ?>"
                                  class="dropdown-item">
                                  <?php echo e(__('Details & Package')); ?>

                                </a>
                                
                                 <a href="<?php echo e(route('admin.edit_management.invoice', ['id' => $vendor->id])); ?>"
                                  class="dropdown-item">
                                  Invoices
                                </a>
                                
                                <a href="<?php echo e(route('admin.edit_management.dealer_edit', ['id' => $vendor->id])); ?>"
                                  class="dropdown-item">
                                  <?php echo e(__('Edit')); ?>
                                ...
                                <a target="_blank"
                                  href="<?php echo e(route('admin.vendor_management.vendor.dealer_secret_login', ['id' => $vendor->id])); ?>"
                                  class="dropdown-item">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u673667181/domains/listit.im/public_html/resources/views/backend/end-user/dealer/index.blade.php ENDPATH**/ ?>