...
<!-- Main script JS -->
<script src="<?php echo e(asset('assets/front/js/script.js?v=0.927')); ?>"></script>
...
<div class="modal fade" id="removeAdRemarkModal" style="opacity: 1 !important;background: #111010a3;" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
     <form action="<?php echo e(route('vendor.cars_management.delete_add')); ?>" method="get">
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input type="range" min="1" max="10" value="1" required name="recommendation" >
...
function filterFormSubmission() {
    ...
    $.ajax({
        url: "<?php echo e(route('frontend.vendor.customer.filter')); ?>", // The URL to send the request to
...
function showFilterSection() {
    ...
    function removeImage()
    {
        ...
        $('#image-preview').html('<img src="<?php echo e(asset('assets/img/noimage.jpg')); ?>" alt="..." class="uploaded-img">');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    {
         $.ajax({
                url: "<?php echo e(route('get_categories_bread')); ?>",
                method: 'GET',
                data: {
                    pid: pid,
                    category:category
    ...
    {
        $.ajax({
        url: "<?php echo e(url('addto')); ?>/"+car_id,
        method: 'GET',
        dataType:'json',
        success: function(response) 
        {
    ...
    function gotothe(type , car_id)
    {
        ...
        $.ajax({
                url: "<?php echo e(route('get_compare_car_datas')); ?>",
                method: 'GET',
                data: {
                    car_id: car_id,
                    car_ids:car_ids,
    ...
    function reportAd() 
    {
        ...
        // Send data via AJAX
        $.ajax({
            url: "<?php echo e(route('report.ad')); ?>",
            method: 'GET',
            data: {
    ...
    function showmore(type , self)
    {
        ...
        {
            $('#showDisTxt').show();
            $('#readBtn').html('<a href="javascript:void(0);" style="color: #0063fc;" onclick="showmore(0 , this)">read less</a>')
        }
        else
        {
             $('#showDisTxt').hide();
    ...
    function saveDraftData(self , column_name = null )
    {
        ...
        if(column_name != null)
        {
            ...
            $.ajax({
                url: '<?php echo e(route("savetodraft")); ?>',
                method: 'GET',
                ...
                success: function (response) 
                {
                    ...
                    if((column_name == 'sub_category_id' || column_name == 'category_id') && ($('#adsMaincat').val()  == 233 || $('#adsMaincat').val()  == 347 ) )
                    {
                        ...
                        $('#ad_price').val(0);
                        $('#selling_label').hide();
                        $('#en_description').attr('placeholder', 'Tell us a bit more about your ad, giving us as much information as possible.');
    ...
    {
        $.ajax({
            url: '<?php echo e(route("deleteToDraft")); ?>',
            method: 'GET',
    ...
    $(document).ready(function () 
    {
        ...
        $('.product-default').on('mouseover', function () {
            ...
            hoverTimeout = setTimeout(function () {
                ...
                $.ajax({
                url: '<?php echo e(route("ad.impression.count")); ?>',
                method: 'GET',
                data: {ad_id : ad_id },
                success: function (response) 
                {
...
<script type="text/javascript">
    ...
    function changeVal(self = null)
    {
       ...
       if (selectedText.trim() === 'Petrol' || selectedText.trim() === 'Diesel') 
        ...
        $.ajax({
            url: "<?php echo e(route('frontend.getEngineCapacity')); ?>",
            type: 'GET',
...
//    return "yes hello";
   $.ajax({
        type: 'GET', 
        url: "<?php echo e(route('frontend.save_search')); ?>",
...
$(document).ready(function() 
{
    ...
    $('.tab-category').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('getnewads')); ?>",
            type: 'GET',
            dataType: 'json', 
    ...
    $(document).on('change', '.makeclickable', function() 
    {
        $.ajax({
            type: 'GET', 
            url: "<?php echo e(route('frontend.getmodels')); ?>",
            data: { make: $(this).val() }, 
            success: function(data) {
...
<?php endif; ?>
<?php /**PATH /home/u673667181/domains/listit.im/public_html/resources/views/frontend/partials/scripts/scripts-v2.blade.php ENDPATH**/ ?>