<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Sellers Details')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="<?php echo e(route('admin.vendor_management.registered_vendor')); ?>"><?php echo e(__('Registered Sellers')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e(__('Sellers Details')); ?></a>
      </li>
    </ul>
  </div>
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-header">
              <div class="h4 card-title"><?php echo e(__('Sellers Information')); ?></div>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u673667181/domains/listit.im/public_html/resources/views/backend/end-user/vendor/details.blade.php ENDPATH**/ ?>