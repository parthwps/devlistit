      ...
      <div class="row gx-xl-5">
        ...
        <div class="col-lg-8 col-xl-9" id="ajaxcall">
          ...
          <div class="row">
            ...
            <div class="red-tag">REDUCED</div>
            @endif


            <div class="product-default border p-15 mb-25" data-id="{{$car_content->id}}">
            <figure class="product-img mb-15">
            <a href="{{ route('frontend.car.details', ['slug' => $car_content->slug, 'id' => $car_content->id]) }}"
            class="lazy-container ratio ratio-2-3">
            <img class="lazyload"
            data-src="{{ asset('assets/admin/img/car-gallery/' . $image_path) }}"
                    ...
                    <div class="author mb-15">
                      @if ($car_content->vendor_id != 0)
                        <a class="color-medium"
                          ...
                          @endif
                          <span>
                            {{ __('By') }} {{ $vendor = optional($car_content->vendor)->username }} .   {{calculate_datetime($car_content->created_at)}}
