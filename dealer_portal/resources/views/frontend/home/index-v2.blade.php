    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        --}}
                  ...
                  <li class="nav-item">
                    <button class="nav-link car_condition active" onclick="changeInput('car')" data-id="24" data-bs-toggle="tab"
                   ...
                   <li class="nav-item">
                    <button class="nav-link car_condition" data-id="0"  onclick="changeInput('market')" data-bs-toggle="tab"
                      data-bs-target="#all" type="button">
                   ...
                   <li class="nav-item">
                    <button class="nav-link car_condition" data-id="39"  onclick="changeInput('property')"  data-bs-toggle="tab"
                      data-bs-target="#all" type="button">
                ...
                <input type="hidden" id="inptVal" value="car" />
             {{--  @endforeach --}}
            </ul>
                  ...
                  <div class="row align-items-center gx-xl-3">
                    <div class="col-lg-12">
                       ...
                       <div class="col-6 col-sm-3 carform">
                        ...
                        <div class="col-12 carformtxt"  style="display: none;">
                          <div class="form-group" style="padding: 15px 0px;">
                           ...
                           <input type="text" class="form-control" id="searchByTitle" style="width: 100%;" name="title" value="" placeholder="Search By Title">
                     ...
                     <div class="col-lg-12 text-md-end">
                      <button type="button" onclick="updateUrlHome()" style="border-radius: 5px;" class="btn btn-primary btn-border-round bg-primary color-white w-100 searchNow">
                        {{ __('Search Now') }}</span>
                      </button>
                    </div> 
                  </div>
...
<!-- Category-area start -->
  @if ($secInfo->category_section_status == 1)
    <section class="category-area category-1 pt-90">
      <div class="container">
        <div class="row">
          <div class="col-12">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="red-tag2">REDUCED</div>
            @endif


                          <div
                            class="row g-0 product-default product-column border radius-md mb-30 align-items-center p-15" data-id="{{$car->id}}">
                            <figure class="product-img col-xl-5">
                              <a href="{{ route('frontend.car.details', ['slug' => $car->slug, 'id' => $car->id]) }}"
                                ...
                                <img class="lazyload"
                                  data-src="{{ asset('assets/admin/img/car-gallery/' . $car->feature_image) }}"  style="transform: rotate({{$car->rotation_point}}deg);" alt="Product">
                              </a>
                              <a href="{{ route('frontend.car.details', ['slug' => $car->slug, 'id' => $car->id]) }}"
                                  ...
                                  <a class="color-medium"
                                    ...
                                    @else
                                      <img class="lazyload blur-up" data-src="{{ asset('assets/img/blank-user.jpg') }}"
                                        alt="Image">
                                    @endif
                                    <span>{{ __('By') }} {{ $vendor = @$car->vendor->username }} .   <?= (new DateTime($car->created_at))->diff(new DateTime())->format('%a') == 0 ? 'Today' : (new DateTime($car->created_at))->diff(new DateTime())->format('%a') . ' days ago' ?></span>
                                  </a>
                                @else
                                  <a
                                  ...
                                  <span><a
                                      ...
                                      {{ $admin->username }}</a> .   <?= (new DateTime($car->created_at))->diff(new DateTime())->format('%a') == 0 ? 'Today' : (new DateTime($car->created_at))->diff(new DateTime())->format('%a') . ' days ago' ?></span> </span>
                                @endif
                              </div>
            ...
            @endif
                        ...
                        <div
                          ...
                          <div class="product-details col-xl-7">
                            ...
                            <span class="product-category font-sm">{{ carBrand($car->brand_id) }}
                              {{ carModel($car->car_model_id) }}      @if ($car->manager_special  == 1)
                        <span class="price-tag" style="margin-left:10px">Manage Special</span>
                        @endif</span> 
                            <h5 class="product-title mb-10">
                              <a
                                href="{{ route('frontend.car.details', ['slug' => $car->slug, 'id' => $car->id]) }}">{{ $car->title }}</a>
