      ...
      <div class="overlay hidden"><div class="overlay-content">
        ...
        <div class="col-md-8 pr-md-0 mb-1">
              ...
              <div class="m-4 d-flex justify-content-between">
                ...
                <div class="m-3 d-flex justify-content-between">
                <script src="https://www.paypal.com/sdk/js?client-id=ASel7yYXF6phidnkRpBayY3xfU_5vepQCEnxTa2CsTiQ0eedYJyq5leCWB6Y4YVcFhP184tpyxF54Raw&currency=GBP"></script>
          ...
          style: {
            ...
            createOrder: function(data, actions) {
                ...
                payer: {
                  ...
                  phone: {
                    phone_number: {
                        national_number: '<?php echo $ad_id->vendor->phone; ?>',
                    }
                  },
                  name: {
