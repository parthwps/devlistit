<div class="sidebar sidebar-style-2"
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        ...
        @endif   -->
                ...
                {{-- package management --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Package Management',
                $rolePermissions)))
            ...
            @elseif (request()->routeIs('admin.package.edit')) active @endif">
              ...
              @elseif (request()->routeIs('admin.package.edit')) show @endif">
                ...
                {{-- car specifications --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Car Specifications',
                $rolePermissions)))
                <li class="nav-item @if (request()->routeIs('admin.car_specification.categories')) active
            ...
            @elseif (request()->routeIs('admin.car_specification.transmission')) active @endif">
                    ...
                    <div id="carSpecification" class="collapse
              ...
              @elseif (request()->routeIs('admin.car_specification.transmission')) show @endif">
                        <ul class="nav nav-collapse">
                            <li class="{{ request()->routeIs('admin.car_specification.condition') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.condition', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">Car Conditions</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.car_specification.categories') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.categories', ['language' => $defaultLang->code]) }}">
                            ...
                            <li class="{{ request()->routeIs('admin.car_specification.brand') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.brand', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">Brands</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.car_specification.model') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.model', ['language' => $defaultLang->code]) }}">
                            ...
                            <li class="{{ request()->routeIs('admin.car_specification.fuel') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.fuel', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">Fuel Types</span>
                                </a>
                            </li>
                            <li
                                class="{{ request()->routeIs('admin.car_specification.transmission') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.car_specification.transmission', ['language' => $defaultLang->code]) }}">
                ...
                <li class="nav-item @if (request()->routeIs('admin.car_management.car')) active
              ...
              @elseif (request()->routeIs('admin.cars_management.edit_car')) show @endif">
                        <ul class="nav nav-collapse">
                            ...
                            <li class="{{ request()->routeIs('admin.cars_management.create_car') ? 'active' : '' }}">
                                <a
                                    href="{{ route('admin.cars_management.create_car', ['language' => $defaultLang->code]) }}">
...
active @endif
        ...
        @endif -->
                ...
                {{-- vendor --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Vendors Management',
                $rolePermissions)))
