...
class DealerManagementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.end-user.dealer.index', compact('vendors'));
    }
    ...
    public function deposit(Request $request)
    {
        ...
        $deposits = Deposit::where('vendor_id', $deposit_id);
        ...
        $total_deposit = Deposit::where('vendor_id' , $deposit_id);
        ...
        $total_withdrwal = Deposit::where('vendor_id' , $deposit_id);
        ...
        $vendor = Vendor::find($deposit_id);
        return view('backend.end-user.dealer.deposit', compact('deposits' , 'deposit_id' , 'startdate' , 'enddate' , 'total_deposit' , 'total_withdrwal' , 'currency_symbol' , 'vendor'));
    }
