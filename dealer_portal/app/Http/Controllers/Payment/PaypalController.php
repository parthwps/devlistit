...
class PaypalController extends Controller
{
    ...
    public function successPaymentOld(Request $request)
    {
        ...
        if ($result->getState() == 'approved') {
            ...
            if ($paymentFor == "membership") {
                ...
                $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Paypal", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $ptitle, $lastMemb);
               ...
               // @unlink(public_path('assets/front/invoices/' . $file_name));
                ...
                $file_name = $this->makeInvoice($requestData, "extend", $vendor, $password, $amount,$vat_amount, $requestData["payment_method"], $vendor->phone, $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $ptitle, $lastMemb);
    ...
    public function successPayment(Request $request)
    {
        ...
        if ($request['order_status'] == 'COMPLETED') {
                ...
                $file_name = $this->makeInvoice($request, "extend", $vendor, $password, $amount,$vat_amount, $request["payment_method"], $vendor->phone, $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $ptitle, $lastMemb);
