...
Route::get('/sendSubEmail', 'CronJobController@emailReport');

Route::get('/user-cron/{id}', 'CronJobController@usercron');
...
Route::get('/get-valid-inputs', 'FrontEnd\CarController@getValidinput')->name('frontend.getValidinput');
...
Route::get('save-ad-to-draft-key-features', 'FrontEnd\UserController@saveToDraftKeyFeature')->name('savetodraftkeyfeature');
...
Route::middleware('change.lang')->group(function () {
    ...
    Route::get('/find-a-dealer', 'FrontEnd\CarController@findADealer')->name('find.a.dealer');
  ...
  Route::get('/vehicle-data2/{vehiclereg}', 'FrontEnd\HomeController@vehicleDatatwo');
...
Route::prefix('/user')->middleware(['guest:web', 'change.lang'])->group(function () {
  ...
  Route::get('/img-removes', 'FrontEnd\UserController@imagermv')->name('user.car.imagermvs');
