...
Route::prefix('customer')->middleware('change.lang')->group(function () {
  ...
  Route::get('/forgot-password', 'Vendor\VendorController@forget_passord')->name('vendor.forget.password');
...
Route::prefix('vendor')->middleware('auth:vendor', 'Deactive')->group(function () {
  ...
  Route::post('/profile/update-banner', 'Vendor\VendorController@uploadImage')->name('vendor.update_profile_banner');
  ...
  Route::get('/invoices', 'Vendor\VendorController@payment_log')->name('vendor.payment_log');
  Route::get('/invoice/payment-log', 'Vendor\VendorController@invoice_payment_log')->name('vendor.invoice_payment_log');
  ...
  Route::prefix('car-management')->group(function ()
  {
    ...
    Route::get('/print_car_stock', 'Vendor\CarController@printCarStock')->name('vendor.car_management.carstock');
    Route::get('/get_vheicle_deatails', 'Vendor\CarController@getVheicleDeatails')->name('vendor.car_management.vheicle_deatails');
    Route::get('/save_more_credits', 'Vendor\CarController@saveMoreCredits')->name('vendor.car_management.save_more_credits');
    Route::get('/get_sub_email', 'Vendor\CarController@getSubEmail')->name('vendor.car_management.getsubemail');
    Route::get('/get_cr_mdl', 'Vendor\CarController@getCrMdl')->name('vendor.car_management.get_cr_mdl');
    Route::get('/submit_emails', 'Vendor\CarController@SubEmail')->name('vendor.car_management.submit_emails');
    Route::get('/my-ads', 'Vendor\CarController@myAds')->name('vendor.car_management.myads');
    Route::get('/dealer-analytics', 'Vendor\CarController@dealerAnalytics')->name('vendor.car_management.dealerAnalytics');
    Route::get('/add-bump', 'Vendor\CarController@addBump')->name('vendor.car_management.addbump');
    Route::get('/get_car_valuation_data', 'Vendor\CarController@getCarValuationData')->name('vendor.car_management.get_car_valuation_data');
    ...
    //==========car slider image
     Route::post('/img-store', 'Vendor\CarController@imagesstore')->name('vendor.car.imagesstore');
        ...
        Route::match(['get', 'post'], '/img-drag', 'Vendor\CarController@imageDrag')->name('vendor.car.drag');
